class Game {
    ...
    props = [
        ...
        [ 1,  4, 'trapdoor',             '☠️', 152,   80,  null, null, 850, "That's a rather ominous design." ],
        ...
        [ 2, 128, 'couch',                '🛋️', 160,   200,  180, 610,  ],
        [ 2, 12,  'rug',                  null, 630,   120,  166, 900, 611 ],
        [ 2, 20,  'door',                 null, 80,    207,  700, 574, 501, "It looks like a jib door." ],
        [ 2, 20,  'clock',                '🕰️', 40,     40,  380, 340, 501, "Looks to have been moved many times.", 5 ],
        [ 2, 20,  'urn',                  '⚱️',  40,     40,  460, 340, 501, "It contains my ashes." ],
        ...
        [ 6,   0, 'beer_keg',             '🛢️', 80,   100,  740,  645,  , "Each is filled with beer." ],
        [ 6,   0, 'beer_keg',             '🛢️', 80,   100,  770,  745,  , "Each is filled with beer." ],
        [ 6,   0, 'beer_keg',             '🛢️', 80,   100,  815,  845,  , "Each is filled with beer." ],
